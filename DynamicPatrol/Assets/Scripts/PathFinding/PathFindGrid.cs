            ...
            if (grid != null && displayGridGizmos)
            {
                foreach (Node n in grid)
                {
                    ...
                    else if (drawType == DrawType.BeforeSpread)
                    {
                        ...
                        else if (n.Direction == 26) Gizmos.color = new Color(0.6f, 0, 0.8f);
                        else if (n.Direction == 27) Gizmos.color = new Color(0.6f, 0.8f, 0f);

                        if (patrolManager.choosenNodeDic.ContainsKey(new Vector2Int(n.gridX, n.gridY))) Gizmos.color = new Color(0, 1, 1);
                    ...
                    else if (drawType == DrawType.AfterSpread)
                    {
                        ...
                        if (patrolManager.spreadGrid[n.gridX, n.gridY].current) {
                            ...
                            else if (patrolManager.spreadGrid[n.gridX, n.gridY].dir == new Vector2Int(-1, -1)) Gizmos.color = new Color(0.6f, 0, 0.8f);
                            else if (patrolManager.spreadGrid[n.gridX, n.gridY].dir == new Vector2Int(1, -1)) Gizmos.color = new Color(0.6f, 0.8f, 0f);
                        } 
